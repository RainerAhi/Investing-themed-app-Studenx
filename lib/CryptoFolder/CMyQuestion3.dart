...
import 'package:studenx_oigev2/pages/InvesteerimiseGraph.dart';
import 'CQuiz3.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:page_transition/page_transition.dart';
import 'package:lottie/lottie.dart';
class CMyQuestion3 extends StatefulWidget {
  const CMyQuestion3({Key? key}) : super(key: key);

  @override
  State<CMyQuestion3> createState() => _CMyQuestion3State();
}

class _CMyQuestion3State extends State<CMyQuestion3> {
  @override
