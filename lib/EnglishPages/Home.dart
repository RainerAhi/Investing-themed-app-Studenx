...
import 'package:studenx_oigev2/EnglishPages/AboutUsEnglish.dart';
import 'package:studenx_oigev2/EnglishPages/CryptoCurrency/CryptoCurrency.dart';
import 'package:studenx_oigev2/EnglishPages/DifficultMeanings.dart';
import 'package:studenx_oigev2/EnglishPages/Stocks/Stocks.dart';
import 'package:studenx_oigev2/EnglishPages/TimerEnglish.dart';
...
import '../pages/InvesteerimiseGraph.dart';
import 'package:animated_text_kit/animated_text_kit.dart';
import 'package:adaptive_theme/adaptive_theme.dart';
import 'dart:math' as math;

import 'GamePageEnglish/game_page_english.dart';
import 'InvestingGraph.dart';
import 'TakingNotes/NotesMain.dart';
                              ...
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 50, top: 305),
                              ...
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 70, top: 305),
                  ...
                  Padding(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.fromLTRB(73, 205, 50, 0),
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                builder: (context) => AlertDialog(
                                  ...
                                  content: Text(
                                    "Our goal is to expand students investment knowledge and create interest in investing, and thus get more young people to invest.",
