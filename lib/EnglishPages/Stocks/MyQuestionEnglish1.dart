...
import 'StocksQuiz.dart';

class MyQuestionEnglish1 extends StatefulWidget {
  const MyQuestionEnglish1({Key? key}) : super(key: key);

  @override
  State<MyQuestionEnglish1> createState() => _MyQuestionEnglish1State();
}

class _MyQuestionEnglish1State extends State<MyQuestionEnglish1> {
  @override
