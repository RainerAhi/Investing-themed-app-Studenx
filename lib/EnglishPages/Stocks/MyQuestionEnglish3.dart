...
import 'StocksQuiz3.dart';

class MyQuestionEnglish3 extends StatefulWidget {
  const MyQuestionEnglish3({Key? key}) : super(key: key);

  @override
  State<MyQuestionEnglish3> createState() => _MyQuestionEnglish3State();
}

class _MyQuestionEnglish3State extends State<MyQuestionEnglish3> {
  @override
