...
class GamePageEnglish extends StatefulWidget {
  ...
  @override
  State<GamePageEnglish> createState() => _GamePageEnglishState();
}

class _GamePageEnglishState extends State<GamePageEnglish> {
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Text("Take a break from learning!", style: GoogleFonts.bebasNeue(
                            fontSize: 35,
                            color: Colors.white,
                          ),),
                        ],
